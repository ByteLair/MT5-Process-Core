...
# Dataset path and target column (kept as constants; actual loading moved to main)
...
def main():
    """Fluxo de treinamento executado somente quando o módulo é chamado diretamente."""
    # Load dataset
