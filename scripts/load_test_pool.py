...
class ConnectionPoolLoadTester:
    ...
    def run_concurrent_load(
        ...
        """
        logger.info(f"Starting load test: {num_queries} {query_type} queries with {num_workers} workers")
    ...
    def run_burst_load(
        ...
        for burst_num in range(num_bursts):
            ...
            with ThreadPoolExecutor(max_workers=burst_size) as executor:
                futures = [
                    executor.submit(query_func, query_counter + i)
...
def main():
    ...
    parser.add_argument(
        ...
        type=int,
        default=10,
        help="Number of bursts (for burst test)"
    )
