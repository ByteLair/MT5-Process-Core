#!/usr/bin/env python3
"""
Backtest CONSERVADOR para estratégia H1
- RR 1:1 (20 pips SL = 20 pips TP)
- Máximo 3 trades por dia
- 1% risco por trade
- Threshold alto (0.55+)
- Custos reais: spread + slippage + commission
"""
import os
import sys
import psycopg2
...
# Backtest configuration - CONSERVADOR
INITIAL_CAPITAL = 10000
RISK_PER_TRADE = 0.01  # 1% do capital
STOP_LOSS_PIPS = 20
TAKE_PROFIT_PIPS = 20  # RR 1:1
